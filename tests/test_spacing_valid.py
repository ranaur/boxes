...
def test_spacing_valid():
    """Test spacing parameter with valid 2-value format"""
    
    print("Testing spacing parameter with valid 2-value format...")
    ...
    # Test: Export with valid 2-value spacing format
    print("\nTesting YAML export with valid 2-value spacing (0.5:2):")
    try:
